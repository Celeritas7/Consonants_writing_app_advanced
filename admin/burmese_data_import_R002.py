...
SELECT '{anchor_esc}', 
    ...
    TRUE,
    FALSE,
    (SELECT id FROM burmese_consonants WHERE burmese_char = '{base_consonant}' LIMIT 1)
...
""")
        ...
        for word_text, word_data in words.items():
            ...
            category = escape_sql(word_data.get("category"))
